...
export default function MicSelectCaseStudyContent() {
    ...
    return (
        ...
        >
            {/* Tech Stack Badges - rendered inside hero via children,
                but positioned visually after hero via negative margin */}
