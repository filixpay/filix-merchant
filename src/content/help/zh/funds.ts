...
export const zhFunds: Record<string, HelpArticleContent> = {
  ...
  "funds/settlements": {
    title: "结算单",
    description:
      "在 FilixPay 商户中心查看结算单与结算记录：总额、手续费、净额、释放、出金与周期数据覆盖。",
    keywords: [
      "结算",
      "结算单",
      "结算记录",
    ...
    body: {
      whoFor: "需要已释放结算事实、周期结算记录，并了解其与提供方对账情况的财务人员。",
      whenToUse:
        "当收单活动应结算到资金后，打开「资金 → 结算 → 结算单」或「结算记录」时使用本指南。",
      beforeYouStart: [
        "明确要排查的结算周期、资产或 Money-In 参考。",
        "确认可访问「资金 → 结算单」与「结算记录」。",
      ],
      blocks: [
        {
          type: "paragraph",
          text: "结算单展示已释放的结算金额（总额、手续费、净额）以及提供方与对账状态。用本页理解结算资金与余额的关系。同属「资金 → 结算」下的「结算记录」按日/周/月汇总周期对账单。",
        },
        {
          type: "heading",
          text: "操作步骤",
        ...
        {
          type: "paragraph",
          text: "结算记录按资产与日/周/月列出周期对账单。可按资产与日期范围筛选，再按对账单键打开详情。列包括对账周期、资产、状态（进行中 / 已关闭）、结算净额、已释放、出金与数据覆盖（正常 / 部分覆盖 / 不一致）。进行中的周期金额为截至当前的实时值；尚未开始的周期不可用。",
        },
        {
          type: "heading",
          text: "结算单详情",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              problem: "预期有结算但列表为空。",
              solution:
                "在结算单或结算记录中确认周期与资产筛选，等待释放时间，并核验相关订单是否已成功后再结算。",
            },
            {
              problem: "结算记录提示周期尚未开始。",
              solution:
                "选择过去或当前的周期范围。未来的日/周/月键尚无对账单。",
            },
          ],
        },
      ],
