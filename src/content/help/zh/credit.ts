    ...
    body: {
      ...
      blocks: [
        ...
        },
        {
          type: "steps",
          items: [
            "在某行选择「调整记录」，查看操作人、旧/新额度、调整金额与时间。",
            "在某行选择「交易流水」，查看业务单号、类型（使用、还款、调整、退款）、金额及用信前/后余额。",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              problem: "左侧菜单没有调整记录。",
              solution:
                "请从信用额度管理行内操作打开「调整记录」或「交易流水」。线上菜单没有独立历史页。",
            },
          ],
        },
      ],
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              field: "总额度",
              description: "该行当前授信上限。",
            },
            {
              field: "已用额度 / 可用额度",
              description: "已使用多少以及还剩多少可用。",
            },
            {
              field: "付款条款",
        ...
        },
        {
          type: "steps",
          items: [
            "在某行选择「调整记录」，查看原额度、新额度、金额、操作人与时间。",
            "在某行选择「交易流水」，查看使用、还款、调整、退款历史及用信前/后金额。",
            "查看完毕后关闭抽屉。",
          ],
        },
        {
